...
used_columns = ['object_id', 'target',
       'det_mjd_diff', 'hostgal_photoz', 'det_magn_min', 'det_magn_mean', 'cvec1', \
'fm_0', 'flux_err_min', 'exp_ratio_fitting_loss', 'det_magn_std', 'gauss_err_5', \
'flux_by_flux_ratio_sq_skew', 'gauss_s_2', 'cvec2', 'cvec5', 'tau_rise', 'fm_1', \
'cvec3', 'fm_5', 'tau_fall', 'gauss_s_3', '__median_absolute_deviation___5_', \
'__median_absolute_deviation___2_', 'CAR_tau', 'fm_2', 'gauss_err_1', \
'det_magn_mean_2', 'det_magn_mean_4', 'det_magn_mean_3', 'cvec0', 'detected_mean', \
'gauss_err_2', 'my_6_certain_width', '__skew___1_', '__skew___2_', 'flux_diff2', \
'gauss_s_4', 'gauss_s_5', 'my_6_est_width', '__stetson_k___3_', 'cvec4', 'fm_4', \
'gauss_s_1', '__percent_close_to_median___2_', 'supernova1_s2_3', \
'__qso_log_chi2_qsonu___0_', 'fm_3', 'det_magn_min_1', 'det_magn_min_0', \
'det_magn_min_2', 'det_magn_min_4', 'det_magn_min_5', 'det_magn_min_3', \
'__freq_varrat___1_', 'gauss_s_0', 'gauss_err_3', '__freq_varrat___4_', \
'flux_skew', 'gauss_err_4', 'magn_fit_4', 'magn_fit_2', 'magn_fit_1', 'magn_fm_5', \
'magn_fm_4', 'magn_fm_1', 'gauss_err_0', 'time_score', 'det_magn_mean_5',
'g_r', 'g_i', 'r_z', 'r_i', 'g_z', 'u_r', 'i_z', \
'fg_r', 'fg_i', 'fr_z', 'fr_i', 'fg_z', 'fu_r', 'fi_z']

tanya_feat = ['det_mjd_diff', 'hostgal_photoz', 'det_magn_min', 'det_magn_mean',
     'cvec1', 'fm_0', 'flux_err_min', 'exp_ratio_fitting_loss',
     'det_magn_std', 'gauss_err_5', 'flux_by_flux_ratio_sq_skew',
     'gauss_s_2', 'cvec2', 'cvec5', 'tau_rise', 'fm_1', 'cvec3', 'fm_5',
     'tau_fall', 'gauss_s_3', '__median_absolute_deviation___5_',
     '__median_absolute_deviation___2_', 'CAR_tau', 'fm_2', 'gauss_err_1',
     'det_magn_mean_2', 'det_magn_mean_4', 'det_magn_mean_3', 'cvec0',
     'detected_mean', 'gauss_err_2', 'my_6_certain_width', 'det_magn_sum_5',
     '__skew___1_', '__skew___2_', 'flux_diff2', 'gauss_s_4', 'gauss_s_5',
     'my_6_est_width', '__stetson_k___3_', 'cvec4', 'fm_4', 'gauss_s_1',
     '__percent_close_to_median___2_', 'supernova1_s2_3',
     '__qso_log_chi2_qsonu___0_', 'fm_3', 'det_magn_min_1', 'det_magn_min_0',
     'det_magn_min_2', 'det_magn_min_4', 'det_magn_min_5', 'det_magn_min_3',
     '__freq_varrat___1_', 'gauss_s_0', 'gauss_err_3', '__freq_varrat___4_',
     'flux_skew', 'gauss_err_4', 'magn_fit_4', 'magn_fit_2', 'magn_fit_1',
     'magn_fm_5', 'magn_fm_4', 'magn_fm_1', 'gauss_err_0', 'time_score',
     'det_magn_mean_5', 'det_magn_skew_5']
...
def do_train(full_train, train_columns, only_one_fold=False, show_confusion_matrix=False, save_importances=False):
    ...
    if len(clfs) > 1:
        ...
        if show_confusion_matrix:
            ...
            plot_confusion_matrix(cnf_matrix, classes=columns_14, normalize=True, title='Confusion matrix')
    return cv_loss, clfs
...
best_loss, clfs = do_train(full_train, best_columns, only_one_fold=only_one_fold, show_confusion_matrix=False,
